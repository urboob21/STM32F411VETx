...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
// click ->sent frame : TxHeader (TxData) -> id: 0x446 : dia chi gui

// ngat nhan -> check FIFO0 ( chua cai RxHeader:Rx frame -> truefiler: dung id ->
				//?? Filter lấy từ cái Fillter nào  . CRC: nằm ở ID từng BOARD
// CAN DATA
